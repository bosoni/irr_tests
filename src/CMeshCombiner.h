...
public:
	CMeshCombiner(irr::f32 sizingTolerance = 0.8, TEXTURE_PADDING_TECHNIQUE technique = ETPT_EXPAND);
	...
	irr::scene::IMesh* combineMeshes(irr::scene::ISceneManager* smgr, irr::core::array<irr::scene::IMeshSceneNode*> nodes, const irr::core::stringc & meshNameInCache, bool clearNodesAfterUse = true, bool useHardwareMappingHint = true);
